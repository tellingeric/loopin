...
.controller('locationController', function($scope, $ionicLoading, $stateParams, $state, $ionicModal,  $compile, $localStorage) {
  ...
  $ionicModal.fromTemplateUrl('templates/mymap.html', {
    scope: $scope,
